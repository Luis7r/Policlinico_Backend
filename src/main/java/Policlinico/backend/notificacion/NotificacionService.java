...
public class NotificacionService {
    ...
    public boolean enviar(String destinatario, String asunto, String contenido) {
        ...
        if (mailSender == null) {
            LOGGER.warn("No se envio correo a {} porque no hay JavaMailSender configurado", destinatario);
            return false;
        }
        ...
        try {
            ...
            LOGGER.warn("No se pudo enviar correo a {}: {}", destinatario, ex.getMessage());
            return false;
        }
    }
}
